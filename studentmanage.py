...
main.geometry('1260x640')
main.resizable(720, 480)
...
Label(left_frame, text="Department", font=labelfont, bg=lf_bg).place(relx=0.2, rely=0.7)
...
tree.heading('Stream', text='Department', anchor=CENTER)
